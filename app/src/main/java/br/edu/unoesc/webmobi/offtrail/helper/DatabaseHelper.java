...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    /**
     * Getters for get the dao object;
     *
     * @return
     * @throws SQLException
     */
    public Dao<Cidade, Integer> getCidadeDao() throws SQLException {
        if (cidadeDao == null) {
            /**
             * "getDao" method from ormlite that returns the DAO Object
             */
  ...
  /*    Forma sem utilizar código no Usuario

        Usuario u = null;
        try {
            u = getUsuarioDao().queryForId(email);
        } catch (SQLException e) {
            e.printStackTrace();
        }
